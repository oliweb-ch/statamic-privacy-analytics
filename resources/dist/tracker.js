(function () {
    ...
    function hasConsent(consentRequired) {
    ...
    function buildBeaconParams({ visitorId, sessionId, newVisitor, newDay, newHour, newPage, pageUrl, referrerUrl }) {
    ...
    function sendBeacon(endpoint, params) {
     ...
     */
    function init({ endpoint, consentRequired = true } = {}) {
